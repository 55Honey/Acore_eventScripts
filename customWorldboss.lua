...
Config_bossSpell5[8] = 70866            --directly applied to the tank with adds alive --shadow blast (knockback + movement speed reduce)
Config_bossSpell6[8] = 40220            --directly applied to the tank when adds are dead --mortal strike placeholder
...
Config_bossSpellTimer5[8] = 13000       -- This timer applies to Config_bossSpell5+6
...
Config_bossSpellModifier1bp0[8] = 3000     -- should be instant damage ??? @55Honey
Config_bossSpellModifier1bp1[8] = 1800     -- dot damage for fire spell
Config_bossSpellModifier2bp0[8] = nil      -- not required if nil
Config_bossSpellModifier2bp1[8] = nil      -- not required if nil
Config_bossSpellModifier3bp0[8] = 1500     -- damage to main target
Config_bossSpellModifier3bp1[8] = 1500     -- damage to secondary target
Config_bossSpellModifier4bp0[8] = nil      -- not required if nil
Config_bossSpellModifier4bp1[8] = nil      -- not required if nil
Config_bossSpellModifier5bp0[8] = 2500     -- base damage of shadow blast
Config_bossSpellModifier5bp1[8] = nil      -- not required if nil
Config_bossSpellModifier6bp0[8] = 4000     -- mortal strike damage
...
Config_bossSpellModifier1bp0[9] = 3000     -- instant damage
Config_bossSpellModifier1bp1[9] = nil      -- not required if nil
Config_bossSpellModifier2bp0[9] = 2000     -- instant damage
...
Config_bossSpellModifier8bp0[9] = nil      -- not required if nil
...
Config_addSpellModifier1bp0[9] = 1250   -- damage modifier
Config_addSpellModifier1bp1[9] = 750    -- damage after jump?
Config_addSpellModifier2bp0[9] = 1500   -- instant damage
Config_addSpellModifier2bp1[9] = 500    -- dot damage
Config_addSpellModifier3bp0[9] = nil    -- not required if nil
Config_addSpellModifier3bp1[9] = nil    -- not required if nil

Config_aura1Add1[9] = nil               -- an aura to add to the 1st add
Config_aura2Add1[9] = nil               -- another aura to add to the 1st ad
Config_aura1Add2[9] = nil               -- an aura to add to the 2nd add
Config_aura2Add2[9] = nil               -- another aura to add to the 2nd add
...
-- yell for the boss when they cast on themself
Config_bossSpellSelfYell[9] = "By the power of Garr"
